...
## UI tour (5 mins)
![UI overview (home/menu/chat/tasks/notifications)](../../images/screenshots/ui-overview.png)

![Welcome (new user guide)](../../images/screenshots/welcome-screen.png)

![Create task entry (Tap to Create)](../../images/screenshots/create-task-button.png)

![Task details (select symbol & toggle notifications)](../../images/screenshots/task-details.png)
